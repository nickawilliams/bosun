...
TEMPLATE_PATH="${SCRIPT_DIR}/bosun.rb.tmpl"
OUTPUT_PATH="${SCRIPT_DIR}/bosun.rb"
...
Arguments:
  ...
  [output] Optional path for the rendered formula (defaults to packaging/homebrew/bosun.rb).
